...
public class For implements Statement {
    ...
    private final Statement struct_first;
    private final Expression condition;
    private final Statement struct_second;

    private final Label point_start = new Label();
    private final Label point_end = new Label();

    public For(Statement struct_first, Expression condition, Statement struct_second, Body body) throws AstException {
