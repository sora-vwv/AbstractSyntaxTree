...
public class CallMethod extends Position implements Expression {

    private final Expression root;
    private final IMethod method;

    public CallMethod(Expression root, String name, ArrayList<Expression> arguments, Position position) throws AstException {
        super(position);
    ...
    public void codegen(MethodVisitor mv) throws AstException {
        root.codegen(mv);
        mv.visitMethodInsn(INVOKEVIRTUAL, method.getParent().getType().getReference(), method.getName(), method.getDescriptor());
    }
