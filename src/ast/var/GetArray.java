...
public class GetArray extends Position implements Expression {

    private final Variable variable;
    private final List<Expression> indexes;

    public GetArray(Variable variable, List<Expression> indexes, Position position) throws AstException {
        super(position);
